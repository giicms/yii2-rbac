...
namespace giicms\rbac\controllers;

use Yii;
use giicms\rbac\models\searchs\Assignment as AssignmentSearch;
use yii\web\Controller;
use yii\web\NotFoundHttpException;
use yii\filters\VerbFilter;
use giicms\rbac\components\Helper;
...
class AssignmentController extends Controller
{
    ...
    public function init()
    {
        ...
        if ($this->userClassName === null)
        {
            ...
            $this->userClassName = $this->userClassName ? : 'giicms\user\models\User';
        }
    }
    ...
    {
        $manager = Yii::$app->getAuthManager();
        $assign = $manager->getAssignments($id);
